...
<div class="login-info">
    <span> <!-- User image size is adjusted inside CSS, it should stay as it --> <img src="<c:url value="/bootstrap-resources/img/argan.jpeg"/>" alt="me" class="online" /> <a href="javascript:void(0);" id="show-shortcut">john.doe <i class="fa fa-angle-down"></i></a> </span>
</div>
<!-- end user info -->
...
<ul>
<li class="active">
    <a href="<c:url value="/"/> " title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Dashboard</span></a>
</li>
<li>
    <a href="#"><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> <span class="menu-item-parent">Human Resources</span></a>
    <ul>
        <li>
            <a href="<c:url value="/hrd/user-management"/> ">User Management</a>
        </li>
        <li>
