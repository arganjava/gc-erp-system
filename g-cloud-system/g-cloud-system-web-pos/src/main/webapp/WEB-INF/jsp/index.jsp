...
<header id="header">
    <div id="logo-group">
        ...
        <span id="logo"> <img src="<c:url value="/bootstrap-resources/img/logo.png"/>" alt="SmartAdmin"> </span>
        ...
        <ul class="header-dropdown-list hidden-xs">
            <li>
                ...
                <ul class="dropdown-menu pull-right">
                    <li class="active">
                        <a href="javascript:void(0);"><img alt="" src="<c:url value=""/>img/flags/us.png"> US</a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><img alt="" src="<c:url value=""/>img/flags/es.png"> Spanish</a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><img alt="" src="<c:url value=""/>img/flags/de.png"> German</a>
                    </li>
                </ul>
            </li>
        </ul>
...
<div class="login-info">
    <span> <!-- User image size is adjusted inside CSS, it should stay as it --> <img src="<c:url value=""/>img/avatars/sunny.png" alt="me" class="online" /> <a href="javascript:void(0);" id="show-shortcut">john.doe <i class="fa fa-angle-down"></i></a> </span>
</div>
<!-- end user info -->
